...
{
	ifstream fin;
	fin.open("C:\\Users\\Thien Huong\\OneDrive\\Desktop\\DOAN1\\Bai2\\Data\\1_in.txt",ios_base::in);
	ofstream fout;
	fout.open("C:\\Users\\Thien Huong\\OneDrive\\Desktop\\DOAN1\\Bai2\\Data\\1_out.txt",ios_base::out);
    //cin>>n>>m>>s>>t;
    ...
    fout<<res;
    fout.close();
   cout<<"Gia tri cua luong cuc dai la: "<<res;
    return 0;
}
